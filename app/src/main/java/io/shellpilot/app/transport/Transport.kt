...
/**
 * Sealed class representing the available transport types in ShellPilot.
...
sealed class Transport {
    ...
    object Telnet : Transport() {
        ...
        override fun getFormatHint(context: Context): String =
            io.shellpilot.app.transport.Telnet.getFormatHint(context)

        override fun createInstance(): AbsTransport = io.shellpilot.app.transport.Telnet()

        override fun parseUri(input: String): Uri? =
            io.shellpilot.app.transport.Telnet.getUri(input)
    }
    ...
    object Local : Transport() {
        ...
        override fun getFormatHint(context: Context): String =
            io.shellpilot.app.transport.Local.getFormatHint(context)

        override fun createInstance(): AbsTransport = io.shellpilot.app.transport.Local()

        override fun parseUri(input: String): Uri? =
            io.shellpilot.app.transport.Local.getUri(input)
    }
